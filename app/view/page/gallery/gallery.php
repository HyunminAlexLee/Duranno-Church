                   ...
                   <div class="col-md-12">
					...
					if (count ( $gallery['gallery'] ) > 0) {
						...
						foreach ( $gallery['gallery'] as $gallery_data ) {
							?>
							<div class="col-xs-6 col-sm-3 m_gallery_list">
								<form id="f_galleryDetail<?=$gallery_data['id']?>" action="/gallery/galleryDetail" method="post">
...
var url = "/gallery/ajax_gallery_list";
    ...
    success: function(oData){
        ...
        if(oData.errormsg != null){
			...
			if (oData.results['gallery'].length > 0) {						
				...
				$html_temp +=	'<div class ="col-xs-6 col-sm-3   m_gallery_list">';
				$html_temp += 		'<form id="f_galleryDetail'+oData.results['gallery'][$i]['id']+'" action="/gallery/galleryDetail" method="post">'
				...
				$html_temp +='<div class ="col-xs-12 col-sm-12 col-md-12 m_page text-center" >'
