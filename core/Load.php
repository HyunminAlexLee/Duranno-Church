...
Class Load
{
    ...
    {
        $path = '../app/controller/page/' . $controller . '.php';
        if (file_exists($path)) {
            require_once $path;
        }
    }
    ...
    static function ControllerAdmin($controller)
    {
    ...
    static function ModelAdmin($model)
    {
    ...
    static function Language($div, $pageName)
    {
    	$file = '../public/include/'.$div.'/'.$pageName;
